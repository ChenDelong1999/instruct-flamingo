...
CUDA_VISIBLE_DEVICES='6' python open_flamingo/instruction_tuning/instruction_dataset_inference.py \
    ...
    --checkpoint_paths '/cpfs/user/chendelong/cache/OpenFlamingo-9B-vitl-mpt7b.pt,/cpfs/user/chendelong/open_flamingo_v2/runs/0709-clever_flamingo_v2-8x80g-2k_context/checkpoint_10.pt'  \
    --cross_attn_every_n_layers 4 \
    --instruction_path '/cpfs/user/chendelong/open_flamingo/datasets/validation_52k.json' \
