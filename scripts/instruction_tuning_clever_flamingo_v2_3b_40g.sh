...
CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6,7' torchrun --nnodes=1 --nproc_per_node=8 --master_port=29502 open_flamingo/instruction_tuning/train.py \
    ...
    --run_name 'runs/0712-clever_flamingo_v2_3b-2k_context-40G' \
    --seed 42 \
    ...
    --resume_from_checkpoint '/cpfs/user/chendelong/cache/OpenFlamingo-3B-vitl-mpt1b-langinstruct/checkpoint.pt' \
    --max_length 2048 \
    --multiturn_augmentation 32 \
    --max_img 16 \
    --skip_check_overlength \
    --train_num_samples 5000000 \
